...
echo "[9] 检查 iPXE: tftp/x86_64/undionly.kpxe"
[[ -f "${DATA_DIR}/tftp/x86_64/undionly.kpxe" ]] && pass "存在 x86_64 undionly.kpxe" || artifact_missing "缺少 tftp/x86_64/undionly.kpxe"
echo "[10] 检查 iPXE: tftp/x86_64-uefi/snponly.efi"
[[ -f "${DATA_DIR}/tftp/x86_64-uefi/snponly.efi" ]] && pass "存在 x86_64-uefi snponly.efi" || artifact_missing "缺少 tftp/x86_64-uefi/snponly.efi"
...
# ---- 12-17. 六个 Alpine 文件(vmlinuz / initramfs-deploy / modloop x 2 架构)----
i=12
