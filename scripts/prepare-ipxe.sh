...
#   x86      -> bin/undionly.kpxe          -> data/tftp/x86/undionly.kpxe   (BIOS PXE)
#   x86_64   -> bin-x86_64-efi/snponly.efi -> data/tftp/x86_64/snponly.efi  (UEFI x86_64)
...
build_x86() {
  ...
  place_artifact "${IPXE_SRC}/bin/undionly.kpxe" \
    "${DATA_DIR}/tftp/x86/undionly.kpxe"
}
...
build_x86_64() {
  ...
  place_artifact "${IPXE_SRC}/bin-x86_64-efi/snponly.efi" \
    "${DATA_DIR}/tftp/x86_64/snponly.efi"
}
