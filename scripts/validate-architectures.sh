...
#
# 校验对象：
#   data/tftp/x86/undionly.kpxe         存在（BIOS/x86 PXE）
#   data/tftp/x86_64/snponly.efi        x86_64 EFI
...
# ---- iPXE TFTP 产物 ----
check_exists "tftp/x86/undionly.kpxe" "${DATA_DIR}/tftp/x86/undionly.kpxe"
# EFI 为 PE32+；x86_64 期望含 x86-64，排斥 aarch64。
check_desc "tftp/x86_64/snponly.efi" "${DATA_DIR}/tftp/x86_64/snponly.efi" \
